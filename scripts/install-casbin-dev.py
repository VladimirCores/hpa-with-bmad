...
CASBIN_MARKER = ROOT / "output" / "casbin" / "casbin-rbac-workspaces.txt"
...
def ensure_files() -> None:
    if not CASBIN_MARKER.exists():
        raise RuntimeError(f"Casbin workspace marker not found: {CASBIN_MARKER}")
