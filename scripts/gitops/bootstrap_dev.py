...
Run `python3 scripts/startup.dev.py --offline --dry-run` from Story 1.1, then continue with Story 1.2 to provision the offline Talos dev cluster.
""",
...
def main() -> int:
    ...
    ensure_script_mode(ROOT / "scripts" / "startup.dev.py")
